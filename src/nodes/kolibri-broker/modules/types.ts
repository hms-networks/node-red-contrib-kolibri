...
export interface Subscription {
    subscribed: boolean;
    handler: (path: string, timestamp: number, quality: number, value: boolean | number | string) => void;
}

export interface IKolibriBrokerNode extends Partial<Node<{ user: string, password: string }>>, KolibriBrokerOptions {
    name: string;
    brokerUrl: string;
    connected: boolean;
    connecting: boolean;
