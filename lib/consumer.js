...
const { KolibriError } = require('./errorcode.js');
...
class KolibriConsumer extends EventEmitter {
        ...
        this.keepalive = {
            ...
            start: function () {
                ...
                this.handler = setTimeout(function () {
                    self.connection.ws.close(ec.WS_CLOSE_KEEPALIVE);
                    self.emit('error', Error(ec.WS_CLOSE_KEEPALIVE));
    ...
    connect() {
        ...
        // register ws event listeners if connection is successful
    ...
    disconnect() {
        ...
        this.connection.ws.removeEventListener('close', this.wsOnClose);
    }
